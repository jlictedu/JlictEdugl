 ...
 * 
 */
package com.jlict.edu.data.controller;
...
import com.jlict.edu.data.service.DataService;

/**
 * <p>Title: com.jlict.hrgl.manager.controller.DataAction.java</p>
 * <p>Description: </p>
...
public class DataAction extends BaseAction {
	...
	public ModelAndView init(HttpServletRequest request, HttpServletResponse response){
		return new ModelAndView("/manager/data");
	}
	
	@RequestMapping(value="/data.do",method=RequestMethod.POST,params="m=backup")
	@ResponseBody  
	...
	@RequestMapping(value="/data.do",method=RequestMethod.POST,params="m=query")
	@ResponseBody
	public Object queryData(HttpServletRequest request, HttpServletResponse response){
		...
		try{
			...
			json = this.dataService.queryData(directory, pageIndex, pageSize);
	...
	@RequestMapping(value="/data.do",method=RequestMethod.GET,params="m=download")
	...
	@RequestMapping(value="/data.do",method=RequestMethod.POST,params="m=delete")
	@ResponseBody
