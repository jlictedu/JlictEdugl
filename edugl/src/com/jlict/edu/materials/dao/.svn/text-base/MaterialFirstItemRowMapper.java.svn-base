 ...
 * @version 1.0
 */
public class MaterialFirstItemRowMapper implements RowMapper<MaterialFirstItemVo>
{

	@Override
	public MaterialFirstItemVo mapRow(ResultSet rs, int arg1) throws SQLException
	{
