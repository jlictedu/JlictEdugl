...
import com.jlict.edu.materials.service.MaterialDirectorSelfService;
 ...
 */
@Controller
public class MaterialDirectorSelfAction extends BaseAction
{
	@Autowired
	private MaterialDirectorSelfService service;
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.GET)
	public ModelAndView initMaterialDirectorSelfPanel()
	{
		return new ModelAndView("/subscription/materialDirectorSelfPanel");
	}
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.GET,params="m=initApproval")
	public ModelAndView initApproval(HttpServletRequest request, HttpServletResponse response)
	{
		...
		return new ModelAndView("/subscription/materialDirectorSelfApproval", "data", vo);
	}
	 ...
	 * 返回类型 ResultJson
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.POST,params="m=approval")
	@ResponseBody
	 ...
	 * 返回类型 PagingJson
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.POST,params="m=queryApplys")
	@ResponseBody
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.GET,params="m=initReadApproval")
	public ModelAndView initReadApproval()
	{
		return new ModelAndView("/subscription/materialDirectorSelfReadApproval");
	}
	 ...
	 * 返回类型 MaterialSelfVo
	 */
	@RequestMapping(value="/materialDirectorSelf.do",method=RequestMethod.POST,params="m=readApproval")
	@ResponseBody
