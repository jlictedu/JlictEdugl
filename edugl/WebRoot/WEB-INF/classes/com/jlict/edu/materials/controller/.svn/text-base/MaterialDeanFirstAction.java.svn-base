...
import com.jlict.edu.materials.service.MaterialDeanFirstService;
 ...
 */
@Controller
public class MaterialDeanFirstAction extends BaseAction
{
	@Autowired
	private MaterialDeanFirstService service;
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.GET)
	public ModelAndView initMaterialFirstPanel(HttpServletRequest request, HttpServletResponse response)
	{
		return new ModelAndView("/subscription/materialDeanFirstPanel");
	}
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.GET,params="m=initApproval")
	public ModelAndView initApproval(HttpServletRequest request, HttpServletResponse response)
	{
		...
		return new ModelAndView("/subscription/materialDeanFirstApproval", "data", vo);
	}
	 ...
	 * 返回类型 ResultJson
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.POST,params="m=approval")
	@ResponseBody
	 ...
	 * 返回类型 PagingJson
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.POST,params="m=queryApplys")
	@ResponseBody
	 ...
	 * 返回类型 ModelAndView
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.GET,params="m=initReadApproval")
	public ModelAndView initReadApply(HttpServletRequest request, HttpServletResponse response)
	{
		return new ModelAndView("/subscription/materialDeanFirstReadApproval");
	}
	 ...
	 */
	@RequestMapping(value="/materialDeanFirst.do",method=RequestMethod.POST,params="m=readApply")
	@ResponseBody
