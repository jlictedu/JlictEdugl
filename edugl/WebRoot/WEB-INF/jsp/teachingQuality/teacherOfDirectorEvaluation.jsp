...
<head>
	...
	<script type="text/javascript">
		...
		function loadHeadData() {
			...
			$.ajax({url:"teacherOfEvaluation.do?m=initHeadInfoByDirector",type:"POST",data:para,dataType:"json",async:false,success:loadHeadDataCallback});
		}
		...
		function initData() {
			var para = {evaluationSettingId: evaluationSettingId};
			$.ajax({url:"teacherOfEvaluation.do?m=initDataByDirector", type:"POST",data:para,dataType:"json",async:false,success:loadInitData});
		}
