...
<head>
	...
	<script type="text/javascript">
			...
			$_grid = $("#maingrid").ligerGrid(
					{
						...
						url : "directorOfEvaluation.do?m=queryEvaluations",
						delayLoad : true,
						width : '99.8%',
						height : '99%',
						pageSize : 20,
		...
		function evaluateCourseByRow(row)
		{
			readWin = $.ligerDialog.open({
				title : "课堂教学质量评估-" + row.course,
				url : 'directorOfEvaluation.do?m=evaluate&evaluationId=' + row.evaluationId,
				width : 960,
				height : 480,
				isResize : true,
				isHidden : false,
...
<body>
	<div class="table_container">
		...
		<div class="button_panel">
			<input type="button" name="evaluate" id="evaluate" value="查询" onClick="queryCourses()" />
			<input type="button" name="evaluate" id="evaluate" value="评估" onClick="evaluateCourse()" />
