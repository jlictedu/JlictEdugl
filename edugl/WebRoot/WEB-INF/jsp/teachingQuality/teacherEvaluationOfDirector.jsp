...
<head>
	...
	<script type="text/javascript">
		...
		function initEvaluationIds() {
			...
			$.ajax({url:"directorOfHistory.do?m=getEvaluationIds", type:"POST",data:para,dataType:"json",async:false,success:loadEvaluationIds});
		}
		...
		function loadData() {
			...
			$.ajax({url:"directorOfHistory.do?m=initData", type:"POST",data:para,dataType:"json",async:false,success:loadDataCallback});
			wait.close();
		}
		...
		function loadHeadData() {
			var para = {evaluationId: currentEvaluationId};
			$.ajax({url:"directorOfHistory.do?m=initHeadInfo",type:"POST",data:para,dataType:"json",async:false,success:loadHeadDataCallback});
		}
