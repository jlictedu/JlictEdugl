...
<head>
	...
	<script type="text/javascript">
		...
		function loadHeadData() {
			...
			$.ajax({url:"directorOfEvaluationsInfo.do?m=initHeadInfoByDirector",type:"POST",data:para,dataType:"json",async:false,success:loadHeadDataCallback});
		}
		...
		function initData() {
			var para = {evaluationSettingId: evaluationSettingId};
			$.ajax({url:"directorOfEvaluationsInfo.do?m=initDataByDirector", type:"POST",data:para,dataType:"json",async:false,success:loadInitData});
		}
