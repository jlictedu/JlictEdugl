...
<head>
	...
	<script type="text/javascript">
		...
		function initEvaluationIds() {
			...
			$.ajax({url:"directorOfEvaluationsInfo.do?m=getEvaluationIds", type:"POST",data:para,dataType:"json",async:false,success:loadEvaluationIds});
		}
		...
		function loadData() {
			...
			$.ajax({url:"directorOfEvaluationsInfo.do?m=initData", type:"POST",data:para,dataType:"json",async:false,success:loadDataCallback});
			wait.close();
		}
		...
		function loadHeadData() {
			var para = {evaluationId: currentEvaluationId};
			$.ajax({url:"directorOfEvaluationsInfo.do?m=initHeadInfo",type:"POST",data:para,dataType:"json",async:false,success:loadHeadDataCallback});
		}
