  ...
  <script type="text/javascript">
        ...
        $(function()
        {
         //显示部门
			...
			onSuccess :function(data){
						if(data.length==0){
							professionalSel.clear();
							professionalSel.clearContent();
        ...
        //显示员工家庭信息登记
           var createWinfl;
        function createfl(){
            createWinfl=$.ligerDialog.open({ title:"教职工家庭信息登记", url: "teacherentrance.do?m=insertInitfl",timeParmName:"r", width: 750,height:500, showMax: true, showToggle: false, isResize: true, isHidden: false,slide: false,allowClose: false});
        }
		...
		poststred1.TEL=new Array();
			...
			$.ajax({
						url:"teacherentrance.do?m=Insert",
						type:"post",
						dataType:"json",
						data:poststred1,
						cache:false,
 			...
 			<tr>
			   <td colspan="6" ><div align="center" class="editView td_div">教职工信息表</div></td>
			 	  ...
			 	  <tr>
				    ...
				    <td width="50" class="editView_td_style" align="center" >教职工性别</td>
				     
				    <td width="150" class="editView_td_style" align="center">教职工身份证号码</td>
				    
				  </tr> 
				  
 				 <tr>
				    <td align="center" ><select id="dp1" name="dp1" title="學院">
                	...
                	<td align="center" ><select id="professional" name="professional" title="职称">
                		<option value="">-请选择职称-</option></select>
                	</td>
				    <td  align="center" ><input   type="text" name="NAME" id="NAME" title="教职工姓名"  value=""/></td>
				    <td  align="center" ><select id="SEX" title="教职工性别" name="SEX">
				    <option value=''>-请选择性别-</option>
                    <option value="男">男</option>
                    <option value="女">女</option>
                    </select></td>				  
				    <td align="center" ><input  type="text" name="CREDENTIAL_NUMBER" id="CREDENTIAL_NUMBER" title="教职工身份证号码"  value=""/></td>
				  	
</tr>	
				    <tr>
				    <td width="50" class="editView_td_style" align="center" >教职工民族</td>
				    ...
				    <td width="100" class="editView_td_style" align="center">入职时间</td>
                    <td width="100" class="editView_td_style" align="center">紧急联系人电话</td>
				   
				  </tr> 
				  
 				 <tr>
 				    <td align="center" ><input  type="text" name="NATION" id="NATION" title="教职工民族"  value=""/></td>
				    <td  align="center" ><input  type="text" name="BORN_DATE" id="BORN_DATE" title="教职工出生日期"  value=""/></td>
				    <td  align="center" ><input  type="text" name="BIRTH_PLACE" id="BIRTH_PLACE" title="教职工出生地"  value=""/></td>
				    <td  align="center" ><input  type="text" id="HOUSE_REGISTE" title="教职工户籍" name="HOUSE_REGISTE" value="" /></td>
