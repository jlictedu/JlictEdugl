    ...
    <script type="text/javascript">
      ...
      //详细
        function detail(){
        	...
        	$.ligerDialog.open({ title:"教职工信息详情", url: 'teacherentrance.do?m=detailInit&id='+row.id, width: 950,height:450, showMax: true,
        ...
        //设置数据参数
			...
			if(professionalSel.getValue().trim()!=''){
				parms.professional=professionalSel.getValue().trim();
			...
			if(stationSel.getValue().trim()!=''){
				parms.station=stationSel.getValue().trim();
        ...
        var djWin;
        function insert(){
            djWin=$.ligerDialog.open({ title:"教职工信息登记表", url: 'teacherentrance.do?m=insertInit',width: 1000,height:500, showMax: true, showToggle: false, isResize: true, isHidden: false,slide: false,allowClose: false});
        ...
        function edit(){
            ...
            editWin = $.ligerDialog.open({ title:"教职工信息修改", url: 'teacherentrance.do?m=editInit&id='+row.id, width: 950,height:450, showMax: true, showToggle: false, isResize: true, isHidden: false,slide: false,allowClose: false});
        }
		...
		<form name="form1" method="post"  id="form1">
			<table cellspacing="0" cellpadding="0"  border="0" class="editView" >
	             <tr style="height:30px;">
	                ...
	                <td align="right" width="100"  class="editView_td_style">职称：</td>
	                <td> <select id="professional" name="professional">
	                ...
	                <td align="left"  width="200"><select title="性别"  id="sex" name="sex"   style="width:100px;">
	                <option value="">-请选择性别-</option>
	                <option value="男">男</option>
	                <option value="女">女</option>
	                </select></td>
					<td align="right" width="100" class="editView_td_style">岗位:</td>
	                <td align="left"  width="200"><select title="岗位"  id="station" name="station"  style="width:100px;">
	                <option value="">-请选择岗位-</option> </select></td>
	             </tr>
