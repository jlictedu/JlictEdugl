	...
	<script type="text/javascript">
		...
		function readApplyByRow(row) {
			readWin = $.ligerDialog.open({
				title : "教材征订-阅读",
				url : 'material.do?m=initReadApply&id=' + row.id,
				width : 720,
				height : 320,
				isResize : true,
				isHidden : false,
		...
		function updateApplyByRow(row) {
			readWin = $.ligerDialog.open({
				title : "教材征订-修改",
				url : 'material.do?m=initUpdateApply&id=' + row.id,
				width : 720,
				height : 280,
				isResize : true,
				isHidden : false,
		...
		function deleteApplyByRow(row) {
			...
			var para = {id: id};
			$.ajax({url:"material.do?m=deleteApply",type:"POST",data:para,dataType:"json",async:false,success:deleteCallback});
		}
...
<body>
	<div class="table_container">
		...
		<div class="button_panel">
			...
			<input type="button" name="readSubscription" id="readSubscription" value="阅读" onClick="readApply()" />
