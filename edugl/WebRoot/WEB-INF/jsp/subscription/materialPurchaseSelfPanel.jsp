	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$_grid = $("#maingrid").ligerGrid({
					...
					url : 'materialPurchaseSelf.do?m=queryApplys',
					delayLoad : true,
					width : '99.8%',
					height : '99%',
					pageSize : 20,
		...
		function readApplyByRow(row) {
			readWin = $.ligerDialog.open({
				title : "教材征订-阅读",
				url : 'materialPurchaseSelf.do?m=initReadApply&id=' + row.id,
				width : 960,
				height : 280,
				isResize : true,
				isHidden : false,
		...
		function exportExcel() {
			...
			exportWin = $.ligerDialog.open({
				title : "教材征订-导出Excel",
				url : 'materialPurchaseSelf.do?m=exportExcel&year=' + year ,
				width : 320,
				height : 160,
				isResize : true,
				isHidden : false,
		...
		function purchase(id)	{
			...
			$.ajax({url:"materialPurchaseSelf.do?m=purchase",type:"POST",data:para,dataType:"json",async:false,success:purchaseCallback});
		}
