	...
	<script type="text/javascript">
		...
		function readApplyByRow(row) {
			readWin = $.ligerDialog.open({
				title : "教材征订-阅读",
				url : 'materialPurchase.do?m=initReadApply&id=' + row.id,
				width : 720,
				height : 320,
				isResize : true,
				isHidden : false,
		...
		function exportExcel() {
			...
			exportWin = $.ligerDialog.open({
				title : "教材征订-导出Excel",
				url : 'materialPurchase.do?m=exportExcel&year=' + year ,
				width : 320,
				height : 160,
				isResize : true,
				isHidden : false,
		...
		function purchase(id)	{
			...
			$.ajax({url:"materialPurchase.do?m=purchase",type:"POST",data:para,dataType:"json",async:false,success:purchaseCallback});
		}
