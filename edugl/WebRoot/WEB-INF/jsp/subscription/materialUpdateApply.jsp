...
<head>
	...
	<script type="text/javascript">
		...
		function updateApply() {
			...
			$.ajax({url:'material.do?m=updateApply',data:sendData,type:'post',dataType:'json',success:updateApplyCallback});
		}
...
<body>
	...
	<div class="table_container">
		<table class="editView" style="margin-top: 5px">
		<tr>
